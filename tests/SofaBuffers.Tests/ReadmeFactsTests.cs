...
public class ReadmeFactsTests
{
    ...
    /// `## Feature flags` used to be listed here as de-facto family shape, but the
    /// family moved: corelib-go, corelib-cpp, corelib-ts, corelib-zig and the rest
    /// now carry it as a `###` subsection, which is what §9's list actually allows.
    /// This README follows them.
    /// </summary>
    [Fact]
